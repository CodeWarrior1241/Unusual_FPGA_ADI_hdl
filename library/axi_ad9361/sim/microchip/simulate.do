# ================================================================================
# axi_ad9361 PolarFire Testbench - QuestaSim Pro Simulation Script
# ================================================================================
# Runs the axi_ad9361 TX-to-RX loopback simulation on the PolarFire port,
# in the QuestaSim Pro / ModelSim Pro simulator that ships with Libero SoC.
...
puts ""
puts "=========================================="
puts "Starting axi_ad9361 PolarFire Simulation..."
...
# +acc=npr keeps nets/ports/registers visible (the TB forces and reads
# hierarchical signals inside the UUT). The only vendor library needed is
# the local 'polarfire' primitive library built by compile.do.
...
# Use -t 1ps: the PolarFire primitive models use 1ns/10ps and 1ps/1ps timescales
# Use -onfinish stop to keep simulation alive after $finish (for waveform inspection)
vsim -t 1ps -onfinish stop -lib work axi_ad9361_tb_opt
