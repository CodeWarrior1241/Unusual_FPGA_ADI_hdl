...
// ***************************************************************************
//
// Efinix port of axi_ad9361_lvds_if
//
// LVDS interface for AD9361/AD9364 transceiver.
//
...
//   - ad_data_clk (clock input)
//   - ad_data_in (data input with DDR)
//   - ad_data_out (data output with DDR)
//
// On Efinix, the physical LVDS I/O and DDR capture/generation are configured
// in Interface Designer. The HDL primitives provide registered passthrough.
//
// INTERFACE DESIGNER SETUP:
// -------------------------
// Configure the following in Efinix Interface Designer:
//
// RX (LVDS inputs with DDR):
//   - rx_clk_in: LVDS RX clock input, route to global clock network
//   - rx_frame_in: LVDS RX with DDR capture
//   - rx_data_in[5:0]: LVDS RX with DDR capture (6 pairs)
//
// TX (LVDS outputs with DDR):
//   - tx_clk_out: LVDS TX with DDR output
//   - tx_frame_out: LVDS TX with DDR output
//   - tx_data_out[5:0]: LVDS TX with DDR output (6 pairs)
//
