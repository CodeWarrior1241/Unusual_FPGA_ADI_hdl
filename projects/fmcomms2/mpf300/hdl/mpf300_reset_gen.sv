// ***************************************************************************
// Reset generator for the MPF300 FMCOMMS2 design — SystemVerilog mirror of
...
//     PolarFire initialization flow loads register init values, so reset
...
//
// Attributes keep Synplify from restructuring the synchronizer flops.
// See doc/MPF300-Splash-Kit/bedrock_migration_design.md.
// ***************************************************************************

`timescale 1ns/100ps

module mpf300_reset_gen #(
